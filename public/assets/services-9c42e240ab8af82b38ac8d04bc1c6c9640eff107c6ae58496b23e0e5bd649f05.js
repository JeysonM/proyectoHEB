...
var ServicesModel = function(_services) {
    ...
    self_s.serviceImage=ko.observable();
    ...
    function createService() {
      ...
      if (!self_s.editingServiceModel().certification)
          {self_s.errorMessages.push("Ingrese cetificaciones del producto.");
          self_s.hasError(true);
           }
      if (!self_s.editingServiceModel().tariff_position)
         {self_s.errorMessages.push("Ingrese posicion arancelaria del producto.");
          self_s.hasError(true);
          }
      if (!self_s.serviceImage()) {
          self_s.errorMessages.push("Suba la imagen del producto");
          self_s.hasError(true);
          }
      if (self_s.hasError())
        return ;
    ...
    function updateService(){
      ...
      service.serviceData = $("#edit_announcementPreview").attr("src");
      ...
      $.ajax({
          ...
          success: function(returnedData){
              ...
              document.location.href="/company/services";
          },
          error: function(error, message) {
              if (error.status == 401)
...
//*********************************************************************
    ...
    function createNewServiceObj(id, commercial_name , feature , description , image_path , tariff_position , certification , visibility_state, company_id, category_id)
    {
      ...
      newService = { "id" : id, "commercial_name" : commercial_name, "feature" : feature, "description" : description,
                    ...
                    "visibility_state" : visibility_state , "company_id" : company_id, "category_id" :category_id};
      return newService;
    }
};
